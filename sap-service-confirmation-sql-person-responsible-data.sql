...
(
  ...
  `CustMgmtPartnerIsMainPartner`       tinyint(1) DEFAULT NULL,
    ...
    CONSTRAINT `SAPServiceConfirmationPersonResponsibleData_fk` FOREIGN KEY (`ServiceConfirmation`) REFERENCES `sap_service_confirmation_general_data` (`ServiceConfirmation`)
) ENGINE = InnoDB
